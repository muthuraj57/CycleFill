        ...
        Scaffold(
            ...
            NavHost(
                ...
                composable<Screen.Dashboard> {
                    val screen = it.toRoute<Screen.Dashboard>()
                    val viewModel =
                        viewModel { appComponent.dashboardScreenViewModelProvider(screen) }
                ...
                composable<Screen.Collections> {
                    val screen = it.toRoute<Screen.Collections>()
                    val viewModel =
                        viewModel {
                ...
                composable<Screen.Items> {
                    val screen = it.toRoute<Screen.Items>()
                    val viewModel =
                        viewModel { appComponent.itemsViewModelProvider(screen) }
                    val screenState by viewModel.viewState.collectAsState()
                    ItemsScreen(
